import { ArrowUp, Boxes, CheckCircle2, ChevronDown, ClipboardCheck, FileCheck2, GitBranch, KeyRound, Layers3, ScrollText, ShieldCheck, SlidersHorizontal, Sparkles, TerminalSquare } from "lucide-react";
